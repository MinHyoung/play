...
public final class Histogram {
    ...
    public static void main(String args[]) {
        long[] INTERVALS = new long[] { 1, 10, 100, 1000, Long.MAX_VALUE };
        Histogram histogram = new Histogram(INTERVALS);

        histogram.addObservation(12);
        histogram.addObservation(121);
        histogram.addObservation(12100000);
        histogram.addObservation(213);
        histogram.addObservation(21312312);
        histogram.addObservation(21312312);
        histogram.addObservation(21312312);
        histogram.addObservation(21312312);
