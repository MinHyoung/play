...
/**
 * Used extensively in Solr.
 * Some background:
 * 1) https://issues.apache.org/jira/browse/SOLR-912
 * 2) https://issues.apache.org/jira/browse/SOLR-2288
 * 3) https://issues.apache.org/jira/browse/SOLR-2292
 * <p/>
...
public class NamedList<T> implements Cloneable, Serializable, Iterable<Map.Entry<String, T>> {
    ...
    public static void main(String[] args) throws Exception {
        ...
        namedList.add("foo", "foobar");

        for (String name : namedList.getAll("foo")) {
            System.out.println("foo -> " + name);
        }

        System.out.println(namedList.nvPairs.size());
        for (int i = 0; i < namedList.size(); i++) {
            System.out.println(namedList.getName(i) + " -> " + namedList.getVal(i));
        }
    }
}
